...
router.post('/spm/rebuild', auth, requireRoles('bto_admin', 'bto_staff', 'lgu_admin', 'lgu_staff'), async (req, res, next) => {
  try {
...
router.get('/spm/status', auth, requireRoles('bto_admin', 'bto_staff', 'lgu_admin', 'lgu_staff'), (req, res) => {
