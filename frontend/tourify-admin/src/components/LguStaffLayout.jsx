    ...
    <div className="dashboard-shell">
      <aside className="dashboard-nav">
        <div className="nav-brand">
          ...
          <div>
            <h2>LGU Staff Desk</h2>
            <p>Municipal Tourism Support</p>
          </div>
        </div>

        <nav>
          {lguStaffNavSections.map((section) => (
        ...
        <div className="nav-footer">
          <div className="footer-user">
            ...
            <div>
              <p className="user-name">LGU Staff</p>
              <p className="user-role">Tourism Support Officer</p>
            </div>
          </div>
