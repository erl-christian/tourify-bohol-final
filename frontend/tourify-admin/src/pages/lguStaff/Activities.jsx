              ...
              recentActivities.map(item => {
                ...
                return (
                  <li key={id} className="table-row table-grid">
                    ...
                    <div className="muted">{item.latestAction || describeStatus(item.status)}</div>
                    <div className="muted">{formatDateTime(item.updatedAt || item.createdAt)}</div>
            ...
            {detailModal.loading ? (
              ...
              <div className="modal-content">
                ...
                <div className="detail-block">
                  ...
                  <p className="detail-value">
                    Owner Account ID: {detailModal.ownerProfile?.account_id || '-'}
                  </p>
                ...
                <div className="detail-block">
                  ...
                  <p className="detail-value">
                    {detailModal.latestApproval?.approval_status || 'No decision yet'}
                  </p>
                  <p className="detail-value">
                  ...
                  <p className="detail-value">
                    Date: {formatDateTime(detailModal.latestApproval?.action_date)}
                  </p>
